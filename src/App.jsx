...
const T = {
  bn: {
    ...
    askBtn:         "জিজ্ঞাসা",
    askNote:        "⚠️ "কেন" ও ব্যাখ্যামূলক প্রশ্ন এখানে উত্তর দেওয়া হয় না। সেগুলোর জন্য একজন আলেমের সাথে পরামর্শ করুন।",
    ...
    sourceText:     "(source text — not AI generated)",
    ...
    searchedArabic: "আরবিতে অনুসন্ধান করা হয়েছে",
  ...
  en: {
    ...
    askBtn:         "Ask",
    askNote:        "⚠️ "Why" and interpretive questions are not answered here. Please consult a qualified Islamic scholar for those.",
    ...
    enTrans:        "🇬🇧 English — Dr. Mustafa Khattab",
    searchedArabic: "Searched in Arabic",
    ...
    howTo: [
      ...
      { icon:"🔖", title:"Save & Share",   desc:"Save verses or generate a beautiful share card." },
    ],
  },
};
      ...
      <div className="app">
        ...
        <aside className="sidebar">
          <div className="sidebar-brand">
            <div className="sidebar-logo" onClick={() => navigate("home")}>هادي</div>
        ...
        <div className="content-wrap">
          ...
          <main className="main">
            ...
            {page === "search"        && <SearchPage t={t} navigate={navigate} audio={audio} />}
            ...
            {page === "surah"         && <SurahPage t={t} data={pageData} navigate={navigate} audio={audio} onBookmarkChange={() => setBookmarkTick(x=>x+1)} />}
    ...
    <div className="page home-page">
      ...
      <div className="section">
        <div className="nav-cards">
          {[
            { id:"search",        icon:"🔍", title:t.wordSearch,  sub: t.searchPlaceholder.split("·")[0].trim()+"…" },
            { id:"surah-browser", icon:"📖", title:t.surahBrowse, sub: t.surahBrowseSub },
            { id:"bookmarks",     icon:"🔖", title:t.savedAyat,   sub: t.saved },
            { id:"ask",           icon:"❓", title:t.askTitle,    sub: t.askSub.split("—")[1]?.trim() },
          ].map(c => (
...
// SURAH PAGE
// ════════════════════════════════════════════════════════════════
function SurahPage({ t, data, navigate, audio, onBookmarkChange }) {
          ...
          return (
            <div key={key} className="surah-ayah-row">
              <div className="surah-ayah-top">
                ...
                <button className="surah-ayah-expand" onClick={() => setExpanded(p => ({...p,[key]:!p[key]}))}>
                  {isEx ? "▲" : "▼"}
                </button>
              </div>
              {isEx && (
    ...
    <div className="page about-page">
      ...
      <div className="about-section">
        ...
        <div className="about-dua-note">
          {isBn
            ...
            : "If you're willing — please also make dua that Allah grants me a righteous spouse. May He grant you the same. 🤲"}
        </div>
      </div>
      ...
      <div className="about-section">
        ...
        <div className="about-builder">
          <a className="about-builder-link" href="https://github.com/mehedyk" target="_blank" rel="noopener noreferrer">
            মেহেদী
          </a>
          {" "}
      ...
      <div className="about-section">
        ...
        <div className="about-tech">
          {["React 18", "Vite", "Vercel", "Hind Siliguri", "KFGQPC Uthman Taha Naskh"].map(t => (
...
function ShareModal({ t, ayah, onClose }) {
  ...
  useEffect(() => {
    ...
    ctx.fillStyle = "rgba(200,184,152,0.45)";
...
const BASE_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ── THEMES ─────────────────────────────────────────────────── */
  :root {
    /* NOOR — warm parchment, forest green, amber gold */
    --bg:       #f5ede0;
    --bg2:      #ede0c8;
    --bg3:      #fdfaf5;
    --ink:      #1c1108;
    ...
    --warn:     #7a3610;
    --warn-bg:  #fff8f0;
    --pattern:  rgba(176,120,40,0.07);
    --sidebar-bg: #1c4a2e;
    --sidebar-ink: rgba(253,250,245,0.9);
    --sidebar-border: rgba(212,160,64,0.2);
  }
  [data-theme="layl"] {
    /* LAYL — deep midnight teal, vivid gold, soft warm text */
    --bg:       #0b1f1a;
    --bg2:      #122820;
    --bg3:      #192e26;
    --ink:      #ede8de;
    ...
    --warn:     #e8a870;
    --warn-bg:  rgba(232,168,112,0.08);
    --pattern:  rgba(212,160,64,0.05);
    --sidebar-bg: #081612;
    --sidebar-ink: rgba(237,232,222,0.9);
    --sidebar-border: rgba(212,160,64,0.15);
  }
  [data-theme="sabz"] {
    /* SABZ — aged manuscript, deep emerald, muted gold */
    --bg:       #f0ece0;
    --bg2:      #e2d8c4;
    --bg3:      #faf8f2;
    --ink:      #141e10;
    ...
    --green:    #1a4e28;
    --green2:   #226634;
    --border:   rgba(138,104,24,0.2);
    --shadow:   rgba(20,30,16,0.10);
    --warn:     #6e3810;
    --warn-bg:  #fdf6ec;
    --pattern:  rgba(26,78,40,0.06);
    --sidebar-bg: #142010;
    --sidebar-ink: rgba(250,248,242,0.9);
    --sidebar-border: rgba(176,136,40,0.2);
  }
  ...
  @media (min-width: 768px) {
    ...
    .sidebar-logo { font-family: 'UthmanNaskh', serif; font-size: 2.2rem; color: var(--gold2); cursor: pointer; line-height: 1; display: block; }
    ...
    .sidebar-link {
      ...
      color: var(--sidebar-ink); opacity: 0.65;
    ...
    .sidebar-ctrl {
      ...
      background: none; border: none; cursor: pointer;
      color: var(--sidebar-ink); opacity: 0.5;
      font-family: 'Hind Siliguri', sans-serif; font-size: 0.78rem;
